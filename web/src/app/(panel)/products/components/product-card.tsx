      ...
      <Card className="w-full max-w-[298px] overflow-hidden">
        ...
        <CardHeader>
          ...
          <CardDescription className="ellipsis-text">
            Lorem ipsum dolor sit amet consectetur. Tortor mauris imperdiet ultrices aliquet. Netus varius sit lorem consectetur consequat.
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex items-center justify-between p-4">
          <strong className="text-muted-foreground font-normal">
            <span className="font-medium text-lg text-zinc-900">US$ 26,90</span> / 3pcs
          </strong>
