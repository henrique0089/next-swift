import { RemoveProductImagesUseCase } from '@app/dashboard/usecases/products/remove-product-images-usecase'
import { PGProductImagesRepository } from '@infra/database/pg/dashboard/repositories/pg-product-images-repository'
